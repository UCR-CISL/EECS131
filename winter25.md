...
<source src="{{ site.baseurl }}/assets/videos/jerryli_CS131 Final Project.mp4" type="video/mp4">
</video>
</div>

* **Tesla Bot** WWe propose a general framework deployed through a NVIDIA Jetbot that can be
